...
.. meta::
   :description lang=en: Build better shooter games using the Low Poly Shooter Pack!
...
Commented Codebase |:heartbeat:|
    ...
    We built this way so you, as the developers, would be able to use, 
    modify and learn from it without having to guess what everything is,
    and does.
